(function () {
  ...
  function institutionalPrint(title, body, code, share) {
    ...
    const logo = window.cimientosIdentity?.get().logo || new URL("assets/logo-cimientos.png", location.href).href;
